...
$sql1 	= "SELECT booking.*,rak.*,users.* FROM booking,rak,users WHERE booking.id_mobil=rak.id 
			and booking.email=users.email and booking.email='$email'";
