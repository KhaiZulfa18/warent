...
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,rak.*,users.* FROM booking,rak,merek,users WHERE booking.id_mobil=rak.id 
			and booking.email=users.email and booking.kode_booking='$kode'";
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Sewa Gudang</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Sewa Gudang</h2></td>
					</tr>
					<tr>
		...
		<div class="container-fluid">
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Biaya Sewa Rak (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
					...
					<?php
						...
						<tr>
							<td colspan='3'>
								<b>*Silahkan transfer total biaya sewa ke ".$result['kode_rek']." maksimal tanggal "?> <?php echo IndonesiaTgl($tglhasil);?> <?php echo ".
							</td>
						</tr>
							";
						}else{
