									...
									?>	
										<tr>
											...
											<td>
												...
												<a href="userdel.php?id=<?php echo $result['id_user'];?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['nama_user'];?>?');"><i class="fa fa-close"></i></a></td>
											</td>
										</tr>
										<?php } ?>
