...
<title>Penyewaan Gudang C4 | Registrasi</title>
<!--Bootstrap -->
      ...
      <div class="user_profile_info">
		...
		<div class="col-md-12 col-sm-10">
              <form  method="post" name="theform" action="registact.php" id="theform" onSubmit="return checkLetter(this);" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="emailid" id="emailid" onBlur="checkAvailability()" placeholder="Username" required="required">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree">Saya Setuju dengan <a class=<a>Syarat dan Ketentuan yang berlaku</a></label>
                </div>
                <div class="form-group">
